...
use crate::app::{notification::NotificationLevel, App, AppState, InputMode, SourceContext};
...
fn status_widget(app: &App) -> Paragraph {
    Paragraph::new(vec![
        Line::from(vec![
            Span::styled(
                " 🐛 ",
                Style::default().fg(Color::Cyan).bg(Color::Rgb(20,20,20)).fg(Color::Black),
            ),
            Span::styled(
            ...
            Span::styled(
                ...
                Style::default().add_modifier(Modifier::BOLD).bg(match app.state {
            ...
            Span::styled(
                ...
                Style::default().fg(match app.notification.level {
